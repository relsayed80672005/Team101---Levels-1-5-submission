...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="gradebook", description="Gradebook from Hell")
    ...
    final_grades = _add_three_file_command(subparsers, "final-grades", "Compute final grades.")
    final_grades.set_defaults(handler=_handle_final_grades)

    student_report = _add_three_file_command(subparsers, "student-report", "Show one student report.")
    ...
    category_report = _add_three_file_command(subparsers, "category-report", "Show category summary.")
...
def _add_three_file_command(subparsers: argparse._SubParsersAction[argparse.ArgumentParser], name: str, help_text: str) -> argparse.ArgumentParser:
